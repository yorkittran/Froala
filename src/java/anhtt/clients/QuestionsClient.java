...
/**
 * Jersey REST client generated for REST resource:QuestionsFacadeREST
 * [anhtt.dtos.questions]<br>
 * USAGE:
 * <pre>
...
public class QuestionsClient {
    ...
    public QuestionsClient() {
        ...
        webTarget = client.target(BASE_URI).path("anhtt.dtos.questions");
    }
    ...
    public <T> List<Questions> findAll_XML(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        GenericType<List<Questions>> list = new GenericType<List<Questions>>(){};
