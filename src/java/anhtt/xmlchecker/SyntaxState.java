...
public class SyntaxState {
    ...
    public static final String WAIT_END_TAG_CLOSE = "waitEngTagClose";
    ...
    public static boolean isNamedChar(char c) {
        return Character.isLetterOrDigit(c) || UNDERSCORE == c || HYPHEN == c
                || PERIOD == c;
    }
